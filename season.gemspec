...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Season automatically creates scopes for your models' datetime columns."
  spec.description   = "Season automatically creates scopes for your models' datetime columns."
